...
<template>
  <div ref="root" class="book-page book-sales-page">
    ...
    <section class="section book-reviews-section">
      ...
      <div id="leave-a-review" class="container review-submission-wrap" data-reveal>
