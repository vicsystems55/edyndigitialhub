...
import { sendContactMessage } from '../services/communications'
...
async function submitForm() {
  ...
  try {
    ...
    error.value = requestError.message || 'We could not send your enquiry. Please email us directly and we will be happy to help.'
  } finally {
    sending.value = false
  }
}
