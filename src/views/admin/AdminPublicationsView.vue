...
.international-toggle{background:var(--surface-soft);border:1px solid var(--border);border-radius:11px;margin:4px 0 6px;padding:14px}.international-toggle span em{color:#b42318;display:block;font-size:.55rem;font-style:normal;font-weight:800;margin-top:6px;text-transform:capitalize}.international-toggle span em.ready{color:var(--green)}
</style>
